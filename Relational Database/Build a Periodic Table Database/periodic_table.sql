...
--
-- Name: elements elements_name_uk; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT elements_name_uk UNIQUE (name);
...
--
-- Name: elements elements_symbol_uk; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT elements_symbol_uk UNIQUE (symbol);
